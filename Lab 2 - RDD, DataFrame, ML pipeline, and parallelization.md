...
- [Task 1](#1-rdd-and-shared-variables): To finish in the lab session on 18th Feb. **Essential**
- [Task 2](#2-dataframe): To finish in the lab session on 18th Feb. **Essential**
- [Task 3](#3-machine-learning-library-and-pipelines): To finish in the lab session on 18th Feb. **Essential**
- [Task 4](#4-exercises): To finish by the following Monday 23rd Feb. ***Exercise***
...
- [ML Pipelines](https://spark.apache.org/docs/4.1.0/ml-pipeline.html)
- [Apache Spark Examples](https://spark.apache.org/examples.html)
- [Basic Statistics - DataFrame API](https://spark.apache.org/docs/4.1.0/ml-statistics.html)
- [Basic Statistics - RDD API](https://spark.apache.org/docs/4.1.0/mllib-statistics.html): much **richer**

### Compact references (highly recommended)

- [Cheat sheet PySpark - RDD Basics](https://s3.amazonaws.com/assets.datacamp.com/blog_assets/PySpark_Cheat_Sheet_Python.pdf)
- [Cheat sheet PySpark - SQL Basics](https://s3.amazonaws.com/assets.datacamp.com/blog_assets/PySpark_SQL_Cheat_Sheet_Python.pdf)
- [Cheat sheet for PySpark (2 page version)](https://github.com/runawayhorse001/CheatSheet/blob/master/cheatSheet_pyspark.pdf)

**Tip**: Try to use as much DataFrame APIs as possible by referring to the [PySpark API documentation](https://spark.apache.org/docs/4.1.0/api/python/index.html). When you try to program something, try to search whether there is a function in the API already.
...
As stated in the [RDD Programming Guide](https://spark.apache.org/docs/4.1.0/rdd-programming-guide.html#parallelized-collections), Spark allows for parallel operations in a program to be executed on a cluster with the following abstractions:
...
#### [Broadcast variables](https://spark.apache.org/docs/4.1.0/rdd-programming-guide.html#broadcast-variables)

To avoid creating a copy of a **large** variable for each task, an accessible (*read-only*!) variable can be kept on each machine - this is useful for particularly large datasets which may be needed for multiple tasks. The data broadcasted this way is cached in [serialized](https://spark.apache.org/docs/4.1.0/tuning.html#serialized-rdd-storage) form and deserialized before running each task. See [Data Serialization](https://spark.apache.org/docs/4.1.0/tuning.html#data-serialization) for more details about serialization.
...
#### [Accumulators](https://spark.apache.org/docs/4.1.0/rdd-programming-guide.html#accumulators)
...
[MLlib](https://spark.apache.org/docs/4.1.0/ml-guide.html) is Spark’s machine learning (ML) library. It provides:
...
More details on parameters can be found in the [Python API documentation](https://spark.apache.org/docs/4.1.0/api/python/reference/api/pyspark.ml.regression.LinearRegression.html).
...
This example is adapted from the [ML Pipeline API](https://spark.apache.org/docs/4.1.0/ml-pipeline.html), with minor changes and additional explanations.
...
**Note**: A *reference* solution will be provided in Blackboard for this part by the following Tuesday.
